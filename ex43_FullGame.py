#exercise 43 FullGame
#Zed`s code of a game example:
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        guesses = 0	###bug, should start with 1 or while loop range <9

        while guess != code and guesses < 10:
            print "BZZZZEDDD! %s" % code ###cheat
            guesses += 1
            guess = raw_input("[keypad]> ")
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        guess = raw_input("[pod # %d]> " % good_pod) ###cheat
